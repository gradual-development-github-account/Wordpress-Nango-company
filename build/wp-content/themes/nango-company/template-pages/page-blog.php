        ...
        <div class="vendor  components  flexboxgrid  row">
          <div class="vendor  components  flexboxgrid  col  col-xs-12">
            <div class="">
              ...
              <p class="theme  modificators  fonts  font-family-3  fonts-titles--xs-up">Excepteur sint occaecat</p>
            </div>
          </div>
        </div>
      </div>
              ...
              <div class="page-blog__post
                ...
                <div class="page-blog__post-image-wrapper
                  ...
                  <img class="post-1__image
                              theme  modificators  images-with-hover  image--full-width" src="<?php echo get_template_directory_uri() . '/sources/theme/images/pages/blog/post-10-cut.jpg'; ?>" alt="alt">
                </div>
                <!--Image wrapper-->
                <!--Hover block-->
                <div class="post-1__hover-block
                  ...
                  <div class="hover-block__image">
                    <img class="theme  modificators  images-with-hover  image--full-width" src="<?php echo get_template_directory_uri() . '/sources/theme/images/pages/blog/images/post-9-vertical_01.jpg'; ?>" alt="alt">
                  </div>
                  ...
                  <div class="page-blog__post-text
                    ...
                    <p class="theme  modificators  fonts  fonts-paragraph--justify
                      ...
                      In any project the important factor is your belief. <br>
                      Without belief, there can be no successful outcome.
                    </p>
                    <span>-Rico Albert</span>
                  </div>
                ...
                <div class="post-1__text-wrapper">
                  ...
                  <p class="theme  modificators  fonts  fonts-paragraph--justify
                            theme  modificators  fonts  fonts-paragraphs--md">
                    Donec ullamcorper nulla non metus auctor fringilla. Etiam porta sem malesuada magna.
                  </p>
                </div>
                <!--Text wrapper-->
              </div>
