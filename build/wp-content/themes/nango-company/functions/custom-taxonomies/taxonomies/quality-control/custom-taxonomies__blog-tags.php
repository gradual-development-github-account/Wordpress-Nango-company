...
//custom-post-types__quality-control
// Регистрация таксономии:
add_action( 'init', 'create_taxonomy_Quality_Control_tags', 0 );
function create_taxonomy_Quality_Control_tags() {
  $args = array(
      'label' => _x( 'Теги контроля качества', 'taxonomy general name' ), // Название таксономии во множественном числе для перевода. По умолчанию: значение аргумента 'name' массива 'labels'.
    // Массив значений таксономии для управления в админ-панели:
      'labels' => array(
          'name' => _x( 'Теги контроля качества', 'taxonomy general name' ), // Общее название таксономии, используется во множественном числе. Соответствует значению label. По умолчанию: _x( 'Метки', 'taxonomy general name' ) или _x( 'Рубрики', 'taxonomy general name' ).
          'singular_name' => _x( 'Теги контроля качества', 'taxonomy singular name' ), // Название таксономии в единственном числе. По умолчанию: _x( 'Метка', 'taxonomy singular name' ) или _x( 'Рубрика', 'taxonomy singular name' ).
          'menu_name' => __( 'Теги контроля качества' ), // Название таксономии в пункте меню. Если не задается, то используется значение label. По умолчанию: 'Метки' или 'Рубрики'.
          'all_items' => __( 'Все теги контроля качества' ), // Текст всех таксономий. По умолчанию: __( 'Все метки' ) или __( 'Все рубрики' ).
          'edit_item' => __( 'Изменить тег контроля качества' ), // Текст изменения таксономии на странице ее редактирования. По умолчанию: __( 'Изменить метку' ) или __( 'Изменить рубрику' ).
          'view_item' => __( 'Просмотреть тег контроля качества' ), // Текст просмотра таксономии, который появляется в навигационном баре админ-панели на странице редактирования данной таксономии. По умолчанию: __( 'Просмотреть метку' ) или __( 'Просмотреть рубрику' ).
          'update_item' => __( 'Обновить тег контроля качества' ), // Текст обновления таксономии во вкладке свойства. По умолчанию: __( 'Обновить метку' ) или __( 'Обновить рубрику' ).
          'add_new_item' => __( 'Добавить новый тег контроля качества' ), // Текст добавления новой таксономии при ее создании. По умолчанию: __( 'Добавить новую метку' ) или __( 'Добавить новую рубрику' ).
          'new_item_name' => __( 'Название' ), // Название таксономии при ее создании и редактировании. По умолчанию: __( 'Название' ).
          'parent_item' => __( 'Родительский' ), // Текст родительской таксономии при создании и редактировании. Для древовидных таксономий. По умолчанию: __( 'Родительская' ).
          'parent_item_colon' => __( 'Родительский:' ), // То же, что и parent_item, но с добавлением двоеточия. По умолчанию: __( 'Родительская:' )
          'search_items' => __( 'Поиск тегов контроля качества' ), // Текст в кнопке поиска на странице всех таксономий. По умолчанию: __( 'Поиск меток' ) или __( 'Поиск рубрик' ).
          ...
          'not_found' => __( 'Тегов контроля качества не найдено.' ), // Текст в случае, если запрашиваемая таксономия не найдена. По умолчанию: __( 'Меток не найдено.' ) или __( 'Рубрик не найдено.' ).
      ),
    ...
    // Перезапись URL. По умолчанию: true.
      'rewrite' => array(
          'slug' => 'tax-blog-tags', // Текст в ЧПУ. По умолчанию: название таксономии.
  ...
  register_taxonomy( 'tax-quality-control-tags', array( 'quality-control' ), $args );
                      //Название таксономии
}
