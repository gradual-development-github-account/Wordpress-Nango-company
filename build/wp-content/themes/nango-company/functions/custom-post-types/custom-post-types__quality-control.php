...
add_action( 'init', 'register_post_type_Quality_Control', 0 );
function register_post_type_Quality_Control() {
  $args = array(
      'label'  => _x( 'Контроль качества', 'Post Type General Name', 'text_domain' ), // Название пользовательского типа записи во множественном числе. По умолчанию: значение аргумента 'name' массива 'labels'.
      'labels' => array(
          'name' => _x( 'Контроль качества', 'Post Type General Name', 'text_domain' ), // Общее название пользовательского типа записи во множественном числе. Переопределяет значение 'label'. По умолчанию: _x( 'Записи', 'Post Type General Name', 'text_domain' ) или _x( 'Страницы', 'Post Type General Name', 'text_domain' ).
          'singular_name' => _x( 'Тип контроля', 'Post Type Singular Name', 'text_domain' ), // Название пользовательского типа записи в единственном числе. По умолчанию: _x( 'Запись', 'Post Type Singular Name', 'text_domain' ) или _x( 'Страница', 'Post Type Singular Name', 'text_domain' ).
          'add_new' => __( 'Добавить новый тип контроля качества', 'text_domain' ), // Текст добавления нового объекта типа записи в разделе 'Записи'/'Страницы' в админ-панели. По умолчанию: __( 'Добавить новую', 'text_domain' ).
          'add_new_item' => __( 'Добавить тип контроля качества', 'text_domain' ), // Текст добавления нового объекта типа записи на странице создания. По умолчанию: __( 'Добавить запись', 'text_domain' ) или __( 'Добавить страницу', 'text_domain' ).
          'edit_item' => __( 'Редактировать тип контроля качества', 'text_domain' ), // Текст редактирования объекта типа записи на странице редактирования. По умолчанию: __( 'Редактировать запись', 'text_domain' ) или __( 'Редактировать страницу', 'text_domain' ).
          'new_item' => __( 'Новый тип контроля качества', 'text_domain' ), // Текст новой объекта типа записи. По умолчанию: __( 'Новая запись', 'text_domain' ) или __( 'Новая страница', 'text_domain' ).
          'view_item' => __( 'Просмотреть тип контроля качества', 'text_domain' ), // Текст просмотра типа записи в админ-баре. По умолчанию: __( 'Просмотреть запись', 'text_domain' ) или __( 'Просмотреть страницу', 'text_domain' ).
          'search_items' => __( 'Поиск типов контроля качества', 'text_domain' ), // Текст на кнопке поиска объектов данного типа записи. По умолчанию: __( 'Поиск записей', 'text_domain' ) или __( 'Поиск страниц', 'text_domain' ).
          'not_found' => __( 'Типов контроля качества не найдено', 'text_domain' ), // Текст в случае отрицательного результата поиска объектов данного типа записи. По умолчанию: __( 'Записей не найдено', 'text_domain' ) или __( 'Страниц не найдено', 'text_domain' ).
          'not_found_in_trash' => __( 'Типов контроля качества в корзине не найдено', 'text_domain' ), // Текст в случае отрицательного результата поиска объектов данного типа записи в корзине. По умолчанию: __( 'Записей в корзине не найдено', 'text_domain' ) или __( 'Страниц в корзине не найдено', 'text_domain' ).
          ...
          'all_items' => __( 'Все типы контроля качества', 'text_domain' ), // Текст всех объектов типа записи в подменю. По умолчанию: __( 'Все записи', 'text_domain' ) или __( 'Все страницы', 'text_domain' ).
          'archives' => __( 'Архивы типов контроля качества', 'text_domain' ), // Текст архивов типа записи. По умолчанию: __( 'Архивы записей', 'text_domain' ) или __( 'Архивы страниц', 'text_domain' ).
          'insert_into_item' => __( 'Вставить тип контроля качества', 'text_domain' ), // Текст добавления медиафайлов в объект типа записи во вкладке 'Добавить медиазапись'. По умолчанию: __( 'Вставить в запись', 'text_domain' ) или __( 'Вставить в страницу', 'text_domain' ).
          ...
          'featured_image' => __( 'Миниатюра типа контроля качества', 'text_domain' ), // Текст в метабоксе миниатюры на странице редактирования типа записи. По умолчанию: __( 'Миниатюра записи', 'text_domain' ).
          ...
          'menu_name' => __( 'Контроль качества', 'text_domain' ), // Текст в пункте меню. По умолчанию: значение аргумента 'name'.
          'name_admin_bar' => __( 'Тип контроля', 'text_domain' ), // Текст в админ-баре во вкладке 'Добавить'. По умолчанию: значение аргумента 'singular_name'.
          'items_list' => __( 'Список типов контроля качества', 'text_domain' ), // Текст Screen reader в заголовке в разделе всех записей/страниц. По умолчанию: __( 'Список записей', 'text_domain' ) или __( 'Список страниц', 'text_domain' ).
      ...
      'menu_position' => 5, /* Порядок расположения в админ-меню. Значение аргумента 'show_in_menu' должно быть true. По умолчанию: null - после пункта 'Комментарии'.
        ...
        */
      'menu_icon' => 'dashicons-randomize', // URL для загрузки изображения в админ-меню. По умолчанию: null - используется изображение пункта меню 'Записи'. Ссылки на изображения доступны здесь: https://developer.wordpress.org/resource/dashicons/
    ...
    */
     ...
     */
      'taxonomies' => array( 'tax-quality-control-categories', 'tax-quality-control-tags' ), // Массив связанных таксономий для данного типа записи. Пользовательскую таксономию необходимо зарегестрировать через функцию register_taxonomy(). По умолчанию: без таксономий.
    ...
    // Возможность перезаписи для данного типа записи. Чтобы предотвратить перезапись, используют значение false. По умолчанию: true и значение $post_type используется как ярлык.
      'rewrite' => array(
          'slug' => 'quality-control', // Текст в ссылке. По умолчанию: значение $post_type.
  ...
  register_post_type( 'quality-control', $args );
}
